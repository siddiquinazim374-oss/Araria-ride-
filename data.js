...
const arariaVillages = [
    ...
    "Bhangiya", "Bishunpur", "Bochi (7585)", "Bochi (1850)", "Chanderdai",
    "Chanrarni", "Chatar", "Chikni", "Dabhara Jagir", "Dabhra", "Deoria",
    "Dhakia", "Diari", "Domai", "Farasat", "Gaigari", "Gainrha", "Gamharia",
    "Gelhabari", "Gharakhal", "Haria", "Hasanpur", "Hyatpur", "Itahara",
    "Jamua", "Jhamta", "Jitwarpur", "Kamaldaha", "Kasaila Gachh Garha Bhagkasail",
    "Khamgara", "Kharhar", "Kismat Jamua", "Kismat Khawaspur", "Kochgawan",
    "Kusiargaon", "Lahna", "Lahtora", "Lodipur", "Lohtora", "Madanpur",
    "Mahisakol", "Majgawan", "Majkuri", "Metan", "Milik", "Mirzapur", "Murbala",
    "Paik Tola", "Pategna", "Phulbari", "Pokharia", "Rajokhar",
    "Rampur Kudarkatti", "Rampur Mohanpur", "Rangdaha", "Saguna", "Sahasmal",
    "Salaigarh", "Samda", "Sandalpur", "Saranpur", "Sisauna", "Surjapur",
    "Tarabari", "Tarauna", "Tirhutbita (1125)", "Tirhutbita (1777)"
];
...
const jokihatVillages = [
    ...
    "Darsana", "Daulatpur", "Dhanpura", "Dharmeshwar Gachh", "Dhobinia",
    "Domahana", "Duba", "Dumaria", "Durgapur", "Gachh Mahadewa", "Gamharia",
    "Gerki", "Ghormara", "Girda", "Gogra", "Hardar", "Jahanpur", "Jokihat",
    "Kachnahar", "Kajleta", "Kakan", "Kakorha", "Karahara",
    "Karahara Chhaprail", "Kariat", "Kesarra", "Khirdaha", "Khuti Kharia",
    "Kishunpur", "Kursail", "Lalia", "Laruabari", "Machhaila", "Mahadewa",
    "Mahalgaon", "Mahjaili", "Majgawan", "Majhua", "Malchhari", "Malharia",
    "Marua", "Masuria (6289)", "Masuria (5547)", "Matiari (690)",
    ...
    "Ramganj", "Ramrai", "Rani", "Rani Istamrar", "Saifullah Tola", "Sapa",
    "Satbhita", "Satbhita Kamat", "Satghara", "Semaria", "Shahpur",
    "Singar Mohani", "Sisauna", "Siswa", "Taran", "Turkaili", "Uda", "Ukhwa"
];
...
const famousPlaces = [
    ...
    { name: "Bhargama Hospital", block: "Bhargama", type: "hospital", lat: 26.1900, lon: 87.3500 },
    { name: "Bhargama Police Station", block: "Bhargama", type: "police", lat: 26.1880, lon: 87.3520 },
    { name: "Kursela Hospital", block: "Kursela", type: "hospital", lat: 26.1000, lon: 87.3800 },
    { name: "Kursela Police Station", block: "Kursela", type: "police", lat: 26.0980, lon: 87.3820 },
    { name: "Narpatganj Hospital", block: "Narpatganj", type: "hospital", lat: 26.3000, lon: 87.4500 },
    { name: "Narpatganj Police Station", block: "Narpatganj", type: "police", lat: 26.2980, lon: 87.4520 },
    { name: "Raniganj Hospital", block: "Raniganj", type: "hospital", lat: 26.2200, lon: 87.2800 },
    { name: "Raniganj Police Station", block: "Raniganj", type: "police", lat: 26.2180, lon: 87.2820 },
    { name: "Sikti Hospital", block: "Sikti", type: "hospital", lat: 26.0800, lon: 87.3000 },
    { name: "Sikti Police Station", block: "Sikti", type: "police", lat: 26.0780, lon: 87.3020 },
    { name: "Sonbarsa Hospital", block: "Sonbarsa", type: "hospital", lat: 26.3500, lon: 87.5200 },
    { name: "Sonbarsa Police Station", block: "Sonbarsa", type: "police", lat: 26.3480, lon: 87.5220 }
];
