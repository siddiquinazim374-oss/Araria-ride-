...
function getSlab(dist) {
    if (dist <= 2) {
        return { rate: 0, fixed: selectedVeh === "bike" ? 25 : selectedVeh === "auto" ? 45 : 40 };
    }
    if (dist <= 5) {
        return { rate: selectedVeh === "bike" ? 12 : selectedVeh === "auto" ? 25 : 22, fixed: 0 };
    }
    if (dist <= 10) {
        return { rate: selectedVeh === "bike" ? 10 : selectedVeh === "auto" ? 22 : 20, fixed: 0 };
    }
    return { rate: selectedVeh === "bike" ? 8 : selectedVeh === "auto" ? 20 : 18, fixed: 0 };
}
